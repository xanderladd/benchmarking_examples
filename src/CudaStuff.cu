...
void stEfork2Main(Stim stim, Sim sim, MYFTYPE* ParamsM, MYFTYPE* InitStatesM, HMat& InMat, MYFTYPE* V, MYDTYPE CompDepth, MYDTYPE CompFDepth, int NSets, int* p2pCapableGPUs, int np2p, int stim_ind, int globalRank) {
  MYFTYPE *Vhots;
  MYFTYPE **vhots_dev;
  MYDTYPE Nt = stim.Nt;
  printf("in stefork\n");
